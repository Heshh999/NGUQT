...
| 7 | A4 residual `resid_tail_5pct` | A | **absent** | passed as `None`, named in ledger | `tests_mrofyt_runner.py` R9 | **NOT WIRED by design** | n/a | not run | an expected-response residual model fitted on prior data; not in frozen code |
